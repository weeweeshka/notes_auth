...
const file_auth_auth_proto_rawDesc = "" +
	...
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponseB\x1eZ\x1cemil.note_auth.v1;notes_authb\x06proto3"
...
var file_auth_auth_proto_depIdxs = []int32{
	0, // 0: auth.NoteAuth.Register:input_type -> auth.RegisterRequest
	2, // 1: auth.NoteAuth.Login:input_type -> auth.LoginRequest
	1, // 2: auth.NoteAuth.Register:output_type -> auth.RegisterResponse
	3, // 3: auth.NoteAuth.Login:output_type -> auth.LoginResponse
